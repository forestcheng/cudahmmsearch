...
\begin{itemize}
 \item {\fontfamily{phv}\fontseries{mc}\selectfont Adobe Helvetica narrow font}\\
 Used for code examples.
 \item {\fontfamily{phv}\fontseries{mc}\selectfont \textsl{Adobe Helvetica narrow slanted font}}\\
 Used for comments of code.
 \item {\fontfamily{pag}\selectfont Adobe AvantGarde font}\\
 Used for caption of table.
\end{itemize}
