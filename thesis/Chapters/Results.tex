...
\end{tabular}
\caption{\fontfamily{pag}\selectfont Performance of optimization approaches\label{tab.opt}}
\end{table}
...
\begin{figure}[!htb]
	...
	\caption{\fontfamily{pag}\selectfont Performance of optimization approaches.}
	\label{fig:imp}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{\fontfamily{pag}\selectfont Practical benchmarks.}
	\label{fig:len}
\end{figure}
...
\begin{figure}[!htb]
	...
	\caption{\fontfamily{pag}\selectfont Comparison with multicore CPU.}
	\label{fig:cpuCores}
\end{figure}
