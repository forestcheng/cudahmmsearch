...
All tests are taken searching the globin4 profile HMM against the SP201309 database.

Table \ref{tab.opt} shows the testing results of this experiment. The fourth column `Improvement' is measured in percentage compared with the previous approach.
