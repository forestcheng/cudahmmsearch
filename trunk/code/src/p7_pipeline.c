 ...
 */
int
p7_Pipeline(P7_PIPELINE *pli, P7_OPROFILE *om, P7_BG *bg, ESL_SQ *sq, P7_TOPHITS *hitlist)
{
...
//  p7_MSVFilterReg(sq->dsq, sq->n, om, pli->oxf, &usc);
...
int
p7_PipelineShort(P7_PIPELINE *pli, P7_OPROFILE *om, P7_BG *bg, ESL_SQ *sq, P7_TOPHITS *hitlist, float usc)
{
	P7_HIT          *hit     = NULL;     /* ptr to the current hit output data      */
