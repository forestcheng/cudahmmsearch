...
extern int p7_Pipeline              (P7_PIPELINE *pli, P7_OPROFILE *om, P7_BG *bg, ESL_SQ *sq, P7_TOPHITS *th);
extern int p7_PipelineShort         (P7_PIPELINE *pli, P7_OPROFILE *om, P7_BG *bg, ESL_SQ *sq, P7_TOPHITS *hitlist, float seq_score);
